 ...
 */
package org.openmrs.module.patient.listener.module.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.PatientpushmoduleController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class PatientpushmoduleController {
